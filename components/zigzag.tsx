      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <div className="inline-flex text-sm font-semibold py-1 px-3 m-2 text-green-600 bg-green-200 rounded-full mb-4">UNIVILLE</div>
            <h1 className="h2 mb-4">Nossos Projetos</h1>
            <p className="text-xl text-gray-400">Conheça alguns projetos realizados pela fábrica!</p>
          </div>
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  <div className="font-architects-daughter text-xl text-green-600 mb-2">FRASE CURTA</div>
                  <h3 className="h3 mb-3">PROJETO 1</h3>
                  <p className="text-xl text-gray-400 mb-4">BREVE DESCRIÇÃO.</p>
