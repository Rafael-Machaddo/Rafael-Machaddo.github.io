      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Conheça um pouco do nosso projeto.</h2>
            <p className="text-xl text-gray-400">Nossa missão, objetivos e valores.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <p className="text-lg text-gray-400 text-center">Promover, realizar e incentivar a transferência do conhecimento, na área da Computação, entre academia e sociedade, atendendo a demandas comunitárias e mantendo  a consonância com os Projetos Pedagógicos dos cursos de graduação na área de Computação da Univille</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Objetivo</h4>
              <p className="text-lg text-gray-400 text-center">Prestar assessoria, consultoria, treinamento e desenvolvimento de soluções de Tecnologia da Informação tanto para projetos da UNIVILLE quanto para projetos oriundos de demanda externa da universidade. </p>
            </div>
